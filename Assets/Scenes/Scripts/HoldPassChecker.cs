...
public class HoldPassChecker : MonoBehaviour
{
    public HoldDotGrid holdDotGridScript; // Reference to the DotGrid script
    ...
    private string presetPassword = "2_0,2_0,2_1,1_1,1_2,0_2,0_2,0_2"; // Stored password pattern

    private void Start()
    {
        // Subscribe to the OnDrawingComplete event
        holdDotGridScript.OnDrawingComplete.AddListener(CheckPassword);
    ...
    private void OnDestroy()
    {
        ...
        holdDotGridScript.OnDrawingComplete.RemoveListener(CheckPassword);
    }

    private void CheckPassword()
    {
        string inputPassword = string.Join(",", holdDotGridScript.visitedDotNames);
